...
class BaseValidatorPlotter(ValidatorPlotter):
    ...
    @staticmethod
    def interpolate_output(y, z, values, extent, mask):
    ...
    def plot(self, y, z, c_true, c_pred, extent, colorbar_limits, titles, mask_inverted=False):
        ...
        mask = self.heat_sink_mask(yi, zi)
        if mask_inverted:
            mask = ~mask  # Invert the mask if needed
        c_true, c_pred = self.interpolate_output(y, z, [c_true, c_pred], extent, mask)
...
class fluidCustomValidatorPlotter(BaseValidatorPlotter):
    ...
    def __call__(self, invar, true_outvar, pred_outvar):
        ...
        return self.plot(y, z, c_true, c_pred, extent, colorbar_limits, titles, mask_inverted=False)
...
class solidCustomValidatorPlotter(BaseValidatorPlotter):
    ...
    def __call__(self, invar, true_outvar, pred_outvar):
        ...
        return self.plot(y, z, c_true, c_pred, extent, colorbar_limits, titles, mask_inverted=True)
